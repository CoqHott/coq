...
val translate_module :
  Constr.ground env -> ModPath.t -> inline -> module_entry -> module_body
...
val translate_modtype :
  Constr.ground env -> ModPath.t -> inline -> module_type_entry -> module_type_body
...
val translate_mse :
  Constr.ground env -> ModPath.t option -> inline -> module_struct_entry ->
...
val finalize_module :
  Constr.ground env -> ModPath.t -> (module_expression option) translation ->
...
val translate_mse_incl :
  bool -> Constr.ground env -> ModPath.t -> inline -> module_struct_entry ->
    unit translation
